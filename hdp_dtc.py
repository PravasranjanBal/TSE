...
t_input_train, t_input_test, t_output_train, t_output_test = train_test_split(t_normalized_input, t_output, test_size=0.3, random_state=42)
...
from sklearn.model_selection import train_test_split
t1_input_train, t1_input_test, t1_output_train, t1_output_test = train_test_split(new_source_input_data, new_source_output_data, test_size=0.2, random_state=43)
...
# Train Decision Tree Classifer
clf = clf.fit(new_input_train,new_output_train)
#Predict the response for test dataset
y_pred = clf.predict(new_input_test)
